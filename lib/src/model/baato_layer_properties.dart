...
abstract class BaatoLayerProperties implements LayerProperties {}

/// Symbol layer properties for Baato maps
///
/// Symbol layers allow placing icons and text at points on the map.
/// This class provides properties to customize the appearance and behavior of symbols.
class BaatoSymbolLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  /// Creates a new symbol layer properties object
  const BaatoSymbolLayerProperties({
    this.iconOpacity,
    this.iconColor,
    this.iconHaloColor,
    this.iconHaloWidth,
  ...
  BaatoSymbolLayerProperties copyWith(BaatoSymbolLayerProperties changes) {
    return BaatoSymbolLayerProperties(
  ...
  factory BaatoSymbolLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoSymbolLayerProperties(
...
class BaatoCircleLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  /// Circle radius.
  ///
  /// Type: number
  ...
  const BaatoCircleLayerProperties({
    this.circleRadius,
    this.circleColor,
    this.circleBlur,
    this.circleOpacity,
  ...
  BaatoCircleLayerProperties copyWith(BaatoCircleLayerProperties changes) {
    return BaatoCircleLayerProperties(
  ...
  factory BaatoCircleLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoCircleLayerProperties(
...
class BaatoLineLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  BaatoLineLayerProperties copyWith(BaatoLineLayerProperties changes) {
    return BaatoLineLayerProperties(
  ...
  factory BaatoLineLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoLineLayerProperties(
...
class BaatoFillLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  const BaatoFillLayerProperties({
    this.fillAntialias,
    this.fillOpacity,
    this.fillColor,
  ...
  BaatoFillLayerProperties copyWith(BaatoFillLayerProperties changes) {
    return BaatoFillLayerProperties(
  ...
  factory BaatoFillLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoFillLayerProperties(
...
class BaatoFillExtrusionLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  const BaatoFillExtrusionLayerProperties({
  ...
  BaatoFillExtrusionLayerProperties copyWith(
      BaatoFillExtrusionLayerProperties changes) {
    return BaatoFillExtrusionLayerProperties(
  ...
  factory BaatoFillExtrusionLayerProperties.fromJson(
...
class BaatoRasterLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  const BaatoRasterLayerProperties({
    this.rasterOpacity,
  ...
  BaatoRasterLayerProperties copyWith(BaatoRasterLayerProperties changes) {
    return BaatoRasterLayerProperties(
  ...
  factory BaatoRasterLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoRasterLayerProperties(
...
class BaatoHillshadeLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  const BaatoHillshadeLayerProperties({
  ...
  BaatoHillshadeLayerProperties copyWith(
      BaatoHillshadeLayerProperties changes) {
    return BaatoHillshadeLayerProperties(
  ...
  factory BaatoHillshadeLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoHillshadeLayerProperties(
...
class BaatoHeatmapLayerProperties implements BaatoLayerProperties {
  // Paint Properties
  ...
  const BaatoHeatmapLayerProperties({
    this.heatmapRadius,
    this.heatmapWeight,
  ...
  BaatoHeatmapLayerProperties copyWith(BaatoHeatmapLayerProperties changes) {
    return BaatoHeatmapLayerProperties(
  ...
  factory BaatoHeatmapLayerProperties.fromJson(Map<String, dynamic> json) {
    return BaatoHeatmapLayerProperties(
